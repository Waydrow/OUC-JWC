...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        StringRequest stringRequest = new StringRequest("http://192.168.1.27/ImageCup/index.php/Home/Ver", new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {
                Log.d("Verify",s);

                ImageRequest imageRequest = new ImageRequest("http://192.168.1.27/ImageCup/verify.jpg",
...
//                    Toast.makeText(this,"获取验证码失败",Toast.LENGTH_SHORT).show();
    ...
    private void attemptLogin() {
        ...
        final String captcha = mCaptchaView.getText().toString(); //验证码

        final int[] threadLoginOverFlag = {0};
        final int[] theadScoreOverFlag = {0};
        ...
        if (cancel) {
            ...
            loginToJWC(email, password, captcha, "http://192.168.1.27/ImageCup/index.php/Home/index/index");
            ...
            public void onResponse(JSONObject jsonObject) {
                ...
                try {
                    if(jsonObject.getString("status").equals("200")){
                        Log.d("JsonStatus",jsonObject.getString("status"));
